      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            AppCard(
              withShadow: true,
              onTap: () => context.push('/nap'),
              child: Row(
                children: [
                  const ToneIconTile(icon: LucideIcons.moon, tone: AppTone.blush),
                  const SizedBox(width: 12),
                  Expanded(
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text('Nap timer', style: sansFont(fontWeight: FontWeight.w700)),
                        Text(
                          NapTimerService.instance.isRunning ? 'Currently napping — tap to view' : 'Start tracking a nap',
