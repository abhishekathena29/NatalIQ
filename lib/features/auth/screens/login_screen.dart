                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: const Icon(LucideIcons.heartHandshake, size: 26, color: AppColors.blushForeground),
                    ),
                    const SizedBox(height: 24),
                    Text('Welcome back', style: displayFont(fontSize: 30, fontWeight: FontWeight.w600)),
                    const SizedBox(height: 6),
                    Text(
                      'Log in to continue your journey with Aanya.',
                      ...
                      child: InkWell(
                        ...
                        child: Container(
                          ...
                          child: _submitting
                              ...
                              : Text('Log in', style: sansFont(fontWeight: FontWeight.w700, color: AppColors.primaryForeground)),
                        ),
                      ),
                    ),
                    const SizedBox(height: 20),
